...
function createEventListeners() {
   ...
   //declare variable for document element wth id of leftarrow, which is in the html document
   var leftarrow = document.getElementById("leftarrow");
   
   //add an event handler to the specified document element (leftarrow)
   //the leftArrow() function will executed when the user clicks the left navigation arrow button
